    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="rounded-xl border border-border bg-card p-6">
            ...
            <div class="space-y-2">
                ...
                <a href="{{ route('admin.reports.export.payments') }}" class="w-full flex items-center gap-3 rounded-lg border border-border p-3 text-left text-sm hover:bg-secondary transition-colors">
        ...
        <div class="rounded-xl border border-border bg-card p-6">
            ...
            <div class="space-y-2">
                ...
                <a href="{{ route('admin.reports.export.grades') }}" class="w-full flex items-center gap-3 rounded-lg border border-border p-3 text-left text-sm hover:bg-secondary transition-colors">
        ...
        <div class="rounded-xl border border-border bg-card p-6">
            ...
            <div class="space-y-2">
                ...
                <a href="{{ route('admin.reports.export.attendance') }}" class="w-full flex items-center gap-3 rounded-lg border border-border p-3 text-left text-sm hover:bg-secondary transition-colors">
        ...
        <div class="rounded-xl border border-border bg-card p-6">
            ...
            <div class="space-y-2">
                ...
                <a href="{{ route('admin.reports.export.students') }}" class="w-full flex items-center gap-3 rounded-lg border border-border p-3 text-left text-sm hover:bg-secondary transition-colors">
        ...
        <div class="rounded-xl border border-border bg-card p-6">
            ...
            <div class="space-y-3">
                <div class="flex justify-between items-center p-2 rounded bg-secondary/50">
                    ...
                    <span class="font-semibold">{{ number_format($stats['total_students'] ?? 0) }}</span>
                </div>
                <div class="flex justify-between items-center p-2 rounded bg-secondary/50">
                    <span class="text-sm text-muted-foreground">Teachers</span>
                    <span class="font-semibold">{{ number_format($stats['total_teachers'] ?? 0) }}</span>
                </div>
                <div class="flex justify-between items-center p-2 rounded bg-secondary/50">
                    <span class="text-sm text-muted-foreground">Total Fees Collected</span>
                    <span class="font-semibold text-emerald-600">TSh {{ number_format($stats['fee_collected'] ?? 0) }}</span>
                </div>
                <div class="flex justify-between items-center p-2 rounded bg-secondary/50">
                    <span class="text-sm text-muted-foreground">Outstanding Fees</span>
                    <span class="font-semibold text-amber-600">TSh {{ number_format($stats['fee_outstanding'] ?? 0) }}</span>
                </div>
                <div class="flex justify-between items-center p-2 rounded bg-secondary/50">
...
function reportGenerator() {
    return {
        ...
        openModal(type) {
            ...
            const routes = {
                'receipt': { title: 'Payment Receipt', url: '{{ route("admin.reports.pdf.receipt") }}' },
                'invoice': { title: 'Fee Invoice', url: '{{ route("admin.reports.pdf.invoice") }}' },
                'fee-statement': { title: 'Fee Statement', url: '{{ route("admin.reports.pdf.fee-statement") }}' },
                'report-card': { title: 'Report Card', url: '{{ route("admin.reports.pdf.report-card") }}' },
                'class-performance': { title: 'Class Performance Report', url: '{{ route("admin.reports.pdf.class-performance") }}' },
                'attendance-student': { title: 'Student Attendance Report', url: '{{ route("admin.reports.pdf.attendance-student") }}' },
                'attendance-class': { title: 'Class Attendance Report', url: '{{ route("admin.reports.pdf.attendance-class") }}' },
                'student-register': { title: 'Student Register', url: '{{ route("admin.reports.pdf.student-register") }}' },
            };
