    ...
    <div class="flex items-center gap-3">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentTerm): ?>
            <div class="hidden text-right sm:block">
                <p class="font-mono text-xs font-medium text-foreground"><?php echo e($currentTerm->name); ?></p>
                <p class="font-mono text-[10px] text-muted-foreground"><?php echo e($currentTerm->academicYear->name); ?></p>
            </div>
        ...
        <span class="hidden font-mono text-xs text-muted-foreground sm:block"><?php echo e(now()->format('D, d M Y')); ?></span>

        <a href="<?php echo e(route('profile')); ?>" class="flex items-center gap-2 rounded-md px-2 py-1.5 text-sm font-medium text-muted-foreground hover:bg-secondary hover:text-foreground">
            ...
            <span class="hidden truncate md:block"><?php echo e($user->name ?? 'User'); ?></span>
        </a>
    </div>
</header>
<?php /**PATH C:\Users\user\shule\resources\views/layouts/_topbar.blade.php ENDPATH**/ ?>