...
<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-50 flex w-64 flex-col border-r border-border bg-card transition-transform duration-200 lg:translate-x-0" x-cloak>
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4">
        <ul class="space-y-1">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $navItems ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($item['group'])): ?>
                    
                    <li class="pt-3 pb-1">
                        <p class="px-3 font-mono text-[10px] font-medium uppercase tracking-[0.18em] text-muted-foreground/60"><?php echo e($item['group']); ?></p>
                    </li>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $item['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $isActive = str_contains($currentRoute ?? '', $subItem['route']);
                        ?>
                        <li>
                            <a href="<?php echo e(route($subItem['route'])); ?>"
                               class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition-colors <?php echo e($isActive ? 'bg-chalkboard/8 text-chalkboard' : 'text-muted-foreground hover:bg-secondary hover:text-foreground'); ?>">
                                <span class="shrink-0">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($subItem['icon']):
                                        case ('users'): ?>
                                ...
                                <span class="truncate"><?php echo e($subItem['label']); ?></span>
                            </a>
                        </li>
                ...
                <?php else: ?>
                    ...
                    <li>
                        <a href="<?php echo e(route($item['route'])); ?>"
                           class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors <?php echo e($isActive ? 'bg-chalkboard/8 text-chalkboard' : 'text-muted-foreground hover:bg-secondary hover:text-foreground'); ?>">
                            <span class="shrink-0">
    ...
    <div class="border-t border-border p-4">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user ?? null): ?>
        <div class="flex items-center gap-3">
            ...
            <div class="min-w-0 flex-1">
                <p class="truncate text-sm font-medium text-foreground"><?php echo e($user->name); ?></p>
                <p class="truncate text-xs text-muted-foreground capitalize"><?php echo e(str_replace('_', ' ', $role)); ?></p>
            </div>
...
<?php /**PATH C:\Users\user\shule\resources\views/layouts/_sidebar.blade.php ENDPATH**/ ?>